import { INTERNAL_PROPERTY_NAME } from "@badeball/cypress-cucumber-preprocessor/dist/constants";
import { OnAfterStep } from "@badeball/cypress-cucumber-preprocessor/dist/plugin-event-handlers";
